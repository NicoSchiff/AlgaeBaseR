...
#' taxonomic information if `add_taxo = TRUE`.
#'
...
#' print(species_data)
AlgaeBase_records_species <- function(scientific_names, api_key = Sys.getenv("ALGAEBASE_API_KEY"), offset = 0, count = 10000, add_taxo = TRUE) {
